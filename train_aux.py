...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        logger.info("load pretrained: {}".format(weights))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/dataset/dataset/ssd/model_meta/yolov7/yolov7-tiny.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7-tiny.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/gesture_jsc.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.custom.p5.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--name', default='exp_aux_hand', help='save to project/name')
    ...
    parser.add_argument('--debug', action='store_true', help='use for debug')
